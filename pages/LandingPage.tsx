        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.h3
              ...
              className="font-bebas text-5xl md:text-7xl text-[var(--ios-text)] uppercase tracking-wide mb-4 px-4 drop-shadow-sm"
            >
              {t.testimonials}
            </motion.h3>
            <motion.p
                      ...
                      >
                        ...
                        <div className="flex-1 space-y-3">
                          <div className="space-y-0.5">
                            <p className="text-[9px] md:text-[10px] uppercase tracking-[0.2em] font-black text-[#FFE50C]">
                              {(t as any)[traKey]}
                            </p>
                            <h4 className="font-bebas text-3xl md:text-4xl text-[var(--ios-text)] tracking-wide uppercase">
                              {testimonial.name}
                            </h4>
            ...
            <div className="flex justify-center gap-4 mt-12 mb-4">
              {Array.from({ length: maxIndex + 1 }).map((_, i) => (
                <button
                  ...
                  className={`h-2 transition-all duration-500 rounded-full ${currentIndex === i ? 'w-10 bg-[#FFE50C]' : 'w-2 bg-[#FFE50C]/20'}`}
