    ...
    <div className="fixed inset-0 z-[100] bg-black overflow-hidden flex items-end md:items-center justify-center">
      ...
      <div className="absolute inset-0 z-0 md:hidden">
        <video autoPlay loop muted playsInline onLoadedData={() => setVideoLoaded(true)}
          className="w-full h-full object-cover object-[80%_center] opacity-75"
          poster="https://res.cloudinary.com/deb7eunq3/video/upload/so_0/v1775008225/SLASH_es1qh5.jpg"
        >
          <source src="https://res.cloudinary.com/deb7eunq3/video/upload/v1775008225/SLASH_es1qh5.mp4" />
        </video>
      ...
      <div className="hidden md:block absolute inset-0 z-0">
        ...
        <div className="absolute inset-y-0 left-0 w-[65%] overflow-hidden">
          <video autoPlay loop muted playsInline onLoadedData={() => setVideoLoaded(true)}
            className="w-full h-full object-cover object-[75%_center] opacity-100"
            poster="https://res.cloudinary.com/deb7eunq3/video/upload/so_0/v1775008225/SLASH_es1qh5.jpg"
          >
            <source src="https://res.cloudinary.com/deb7eunq3/video/upload/v1775008225/SLASH_es1qh5.mp4" />
          </video>
